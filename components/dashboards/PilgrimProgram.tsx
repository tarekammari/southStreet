...
import { Calendar, MapPin, Plane, UserRound, Clock, MessageCircle, Compass } from 'lucide-react';
  ...
  return (
    <div className="space-y-5 animate-fade-up" dir="rtl">
      <div className="luxury-card p-6 flex flex-col md:flex-row justify-between gap-4">
        <div>
          <span className="text-[11px] font-bold text-emerald-700 bg-emerald-soft px-3 py-1 rounded-full inline-block mb-2">
            برنامجك المعتمد
          </span>
